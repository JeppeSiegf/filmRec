...
async def fetch_page_info(film_refs, collector: Type[PageCollector], sem: int) -> List[Dict]:
...
async def _fetch_and_extract(
        ...
        collector_cls: Type[PageCollector]
) -> dict | None:
...
def fetch_users(user, timespan: TimePeriodSort = None, order: UserSorting = None):
    ...
    collector = UserListCollector(user)
...
Tuple[RatingRangeFilter, RatingRangeFilter]] = None,
    ...
    collector = MemberListCollector(film, stop_page, stop_user)
